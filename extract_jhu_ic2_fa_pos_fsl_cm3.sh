...
mask="/Users/erdemtaskiran/Desktop/jICA/FA/IC2_FA_mask_4.nii.gz"
zmap="/Users/erdemtaskiran/Desktop/jICA/FA/Artist_joint_comp_ica_feature_2_002.nii.gz"
output="JHU_IC5_FA_pos_overlap_fALFF_thr0_cm3.csv"
...
do
    ...
    fslmaths "$atlas" -thr $label -uthr $label -bin tract_mask_${label}.nii.gz
    ...
    # Write to CSV
    echo "$label,\"$tractname\",$vox,$vol_mm3,$volume_cm3,$t_vox,$overlap_percent,$maxz,$cog_x,$cog_y,$cog_z" >> "$output"
